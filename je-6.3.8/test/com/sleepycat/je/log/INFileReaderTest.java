...
public class INFileReaderTest extends TestBase {
    ...
    private void createLogFile(int numIters)
        ...
        for (int i = 0; i < numIters; i++) {
            ...
            bin.log(
                logManager, false /*allowDeltas*/, false /*allowCompress*/,
                true /*isProvisional*/, false /*backgroundIO*/, in);
            ...
            ln.log(
                envImpl, DbInternal.getDatabaseImpl(db),
            ...
            binDeltaBin.log(
                logManager, true /*allowDeltas*/, false /*allowCompress*/,
                false /*isProvisional*/, false /*backgroundIO*/, in);
    ...
    private void checkLogFile(INFileReader reader,
        ...
        try {
            ...
            while (reader.readNextEntry()) {
                ...
                inFromLog.setDatabase(DbInternal.getDatabaseImpl(db));

                inFromLog.latch(CacheMode.UNCHANGED);

                if (inFromLog.isBINDelta()) {
                    inFromLog.mutateToFullBIN();
                }
