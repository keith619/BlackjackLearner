...
public class DatabaseTest extends DualTestCase {
    ...
    */
    ...
    public void testPreloadInternalMemoryLimit()
        ...
        env.getEnvironmentImpl().getMemoryBudget().getMinTreeMemoryUsage();
        long currTreeMemUsage = 
        env.getEnvironmentImpl().getMemoryBudget().getTreeMemoryUsage();
    ...
    public void testPreloadNoLNs()
        ...
        stats = myDb.preload(conf);
        int numLNsLoaded = stats.getNLNsLoaded();
        int numEmbeddedLNs = stats.getNEmbeddedLNs();
        assertTrue(numLNsLoaded == 1000 || numEmbeddedLNs == 1000);
