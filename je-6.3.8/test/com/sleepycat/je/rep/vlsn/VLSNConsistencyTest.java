...
public class VLSNConsistencyTest extends TestBase {
    ...
    public void testVLSNConsistency() 
        ...
        try {
            ...
            RepNode repNode = RepInternal.getRepImpl(master).getRepNode();
            ...
            FlushHook flushLogHook = 
                new FlushHook(flushHook, RepInternal.getRepImpl(master));
            RepInternal.getRepImpl(master).getLogManager().
