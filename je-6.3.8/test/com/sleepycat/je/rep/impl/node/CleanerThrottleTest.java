...
public class CleanerThrottleTest extends TestBase {
    ...
    private int maxFileDeletionBacklog = 5;
    private int fileDeletionBacklogRange = 5;
    ...
    public void setUp()
        ...
        repConfig.setConfigParam(RepParams.MIN_RETAINED_VLSNS.getName(), "10");
    ...
    public void testAllNodesCleanReplayCost()
         ...
         * cost should protect more files in this case
         */
        maxFileDeletionBacklog = 15;
    ...
    public void testAllNodesCleanInsufficientFreeSpace()
        ...
        /* First expect more files to be retained */
        maxFileDeletionBacklog = 15;
    ...
    public void testTwoNodesClean()
        ...
        /*
         * Note that, for now, we have no optimization that lets us
         * clean files with no VLSNs if they are within the files in
         * the VLSN range, so there will be a large deletion backlog.
         */
        maxFileDeletionBacklog = 95;
    ...
    public void testTwoNodesCleanSecondary()
        ...
        /*
         * No extra files should remain undeleted because the global CBVLSN is
         * not in operation for secondary nodes
         */
        maxFileDeletionBacklog = 15;
    ...
    private void cleanAndCheck(boolean killOneNode) {
        ...
        for (RepEnvInfo repi : repEnvInfo) {
            ...
            if (killOneNode && killOneNodePinsVLSN) {
                 ...
                 * VLSNs left.
                 */
                assertTrue("First VLSN should be greater than 1000, was " +
                           range.getFirst(),
            ...
            final int minFileDeletionBacklog =
                maxFileDeletionBacklog - fileDeletionBacklogRange;
            assertTrue("fileDeletionBacklog should be between " +
                       minFileDeletionBacklog + " and " +
                       maxFileDeletionBacklog + ", was " +
                       fileDeletionBacklog,
                       (minFileDeletionBacklog <= fileDeletionBacklog) &&
                       (fileDeletionBacklog <= maxFileDeletionBacklog));
