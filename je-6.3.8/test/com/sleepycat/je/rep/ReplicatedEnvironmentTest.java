...
public class ReplicatedEnvironmentTest extends RepTestBase {
    ...
    public void testRepEnvMutableConfig() {
        ...
        assertEquals("localhost:13100",
                     RepInternal.getRepImpl(repEnv).getConfigManager().get(RepParams.HELPER_HOSTS));
        repEnv.close();
    }
    ...
    public void testRepInaddrAnyConfig() {
        ...
        assertTrue(!repEnv.getRepImpl().getRepNode().getServiceDispatcher().
                   getSocketBoundAddress().isAnyLocalAddress());
        repEnv.close();
